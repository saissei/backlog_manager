$(function(){
  ...
  chrome.storage.sync.get("KeyInfo", function(data){
    ...
    axios.get(`${backlog}/projects/${sData.pj}/users?${$.param(params)}`)
    .then(res => {
...
$(function(){
  ...
  chrome.storage.sync.get("KeyInfo", function(data){
    ...
    let params = { "apiKey": apiKey };
    axios.defaults.headers['Content-Type'] = 'application/x-www-form-urlencoded';
    axios.get(`${backlog}/projects/${sData.pj}/issueTypes?${$.param(params)}`)
    .then(res => {
...
$(function(){
  ...
  chrome.storage.sync.get("KeyInfo", function(data){
    ...
    let params = { "apiKey": apiKey };
    axios.defaults.headers['Content-Type'] = 'application/x-www-form-urlencoded';
    axios.get(`${backlog}/projects/${sData.pj}/categories?${$.param(params)}`)
    .then(res => {
      console.log(res.data)
      const data = (res.data).map(item => ({
        "Name": item.name,
...
$(function(){
  ...
  chrome.storage.sync.get("KeyInfo", function(data){
    ...
    let params = { "apiKey": apiKey };
    axios.defaults.headers['Content-Type'] = 'application/x-www-form-urlencoded';
    axios.get(`${backlog}/priorities?${$.param(params)}`)
    .then(res => {
      console.log(res.data)
      const data = (res.data).map(item => ({
        "Name": item.name,
